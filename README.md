...
3)To analyze how an open-source tool exists and operates inside a Linux environment.
4)To gain hands-on experience with Linux shell scripting.
...
3)Printing a short description of Python
...
2)Counts occurrences of the keyword
